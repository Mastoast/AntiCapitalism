...
const simpletrash_texture := preload("res://sprites/Otchoz/TruckTrash/SimpleTrash.png")
const bigtrash_texture := preload("res://sprites/Otchoz/TruckTrash/BigTrash.png")

const pattern1 = { "nb_fail_accepted" : 1, "2d_sprite": simpletrash_texture, "anim_sprite": "Pat01/Pat01Anim01.png", "pattern" :
...
const pattern2 = { "nb_fail_accepted" : 1, "2d_sprite": simpletrash_texture, "anim_sprite": "Pat02/Pat02Anim01.png", "pattern" :
...
const pattern3 = { "nb_fail_accepted" : 2, "2d_sprite": simpletrash_texture, "anim_sprite": "Pat03/Pat03Anim01.png", "pattern" :
...
const pattern4 = { "nb_fail_accepted" : 2, "2d_sprite": simpletrash_texture, "anim_sprite": "Pat04/Pat04Anim01.png", "pattern" :
...
const pattern5 = { "nb_fail_accepted" : 3, "2d_sprite": bigtrash_texture, "anim_sprite": "Pat05/Pat05Anim01.png", "pattern" :
[ # difficulty 2.5 PLASTIC CONTAINER
	...
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(600.0, 250.0), "timer": 2.0, 	"anim_sprite":"Pat05/Pat05Anim06.png", "draw_line" : true},
	{"input": "input_right"	, "delay": 1.0, 	"position": Vector2(600.0, 450.0), "timer": 2.0, 	"anim_sprite":"Pat05/Pat05Anim07.png", "draw_line" : true},
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(800.0, 450.0), "timer": 2.0, 	"anim_sprite":"Pat05/Pat05Anim08.png", "draw_line" : true},
	{"input": "input_right"	, "delay": 1.0, 	"position": Vector2(800.0, 650.0), "timer": 2.0, 	"anim_sprite":"Pat05/Pat05Anim09.png", "draw_line" : true},
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(1000.0, 650.0), "timer": 2.0, 	"anim_sprite":"Pat05/Pat05Anim10.png", "draw_line" : true},
	{"input": "input_right"	, "delay": 1.0, 	"position": Vector2(1000.0, 880.0), "timer": 2.0, 	"anim_sprite":"Pat05/Pat05Anim11.png", "draw_line" : true},
	{"input": "input_action", "delay": 2.0, 	"position": Vector2(1200.0,  650.0), "timer": 3.0, 	"anim_sprite":"Pat05/Pat05Anim12.png", "draw_line" : true},
]}

const pattern6 = { "nb_fail_accepted" : 3, "2d_sprite": bigtrash_texture, "anim_sprite": "Pat06/Pat06Anim01.png", "pattern" :
[ # difficulty 3 DOUBLE CONTAINER
	{"input": "input_action", "delay": 2.0, 	"position": Vector2(1200.0,  650.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim02.png", "draw_line" : true},
	{"input": "input_left"	, "delay": 2.0, 	"position": Vector2(1200.0, 880.0), "timer": 3.0, 	"anim_sprite": "Pat06/Pat06Anim03.png", "draw_line" : true},
	{"input": "input_up"	, "delay": 1.0, 	"position": Vector2(400.0, 880.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim04.png", "draw_line" : true},
	{"input": "input_action", "delay": 2.0, 	"position": Vector2(1200.0,  650.0), "timer": 3.0, 	"anim_sprite": "Pat06/Pat06Anim05.png", "draw_line" : true},
	{"input": "input_right"	, "delay": 2.0, 	"position": Vector2(400.0, 250.0), "timer": 3.0, 	"anim_sprite": "Pat06/Pat06Anim06.png", "draw_line" : true},
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(600.0, 250.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim07.png", "draw_line" : true},
	{"input": "input_right"	, "delay": 1.0, 	"position": Vector2(600.0, 450.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim08.png", "draw_line" : true},
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(800.0, 450.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim09.png", "draw_line" : true},
	{"input": "input_action", "delay": 2.0, 	"position": Vector2(1200.0,  650.0), "timer": 3.0, 	"anim_sprite": "Pat06/Pat06Anim10.png", "draw_line" : true},
	{"input": "input_left"	, "delay": 2.0, 	"position": Vector2(1000.0, 250.0), "timer": 3.0, 	"anim_sprite": "Pat06/Pat06Anim11.png", "draw_line" : true},
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(800.0, 250.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim12.png", "draw_line" : true},
	{"input": "input_left"	, "delay": 1.0, 	"position": Vector2(800.0, 450.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim13.png", "draw_line" : true},
	{"input": "input_up"	, "delay": 1.0, 	"position": Vector2(600.0, 450.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim14.png", "draw_line" : true},
	{"input": "input_left"	, "delay": 1.0, 	"position": Vector2(600.0, 250.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim15.png", "draw_line" : true},
	{"input": "input_down"	, "delay": 1.0, 	"position": Vector2(400.0, 250.0), "timer": 2.0, 	"anim_sprite": "Pat06/Pat06Anim16.png", "draw_line" : true},
	{"input": "input_right"	, "delay": 2.0, 	"position": Vector2(400.0, 880.0), "timer": 3.0, 	"anim_sprite": "Pat06/Pat06Anim17.png", "draw_line" : true},
]}
