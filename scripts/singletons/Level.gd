...
Night {night_count}[/center][/font_size]""",
	...
	{"distance": 5.5, "sprite": Color.DARK_GREEN, "pattern": Pattern.pattern2},
]}
...
Night {night_count}[/center][/font_size]"""
	...
	{"distance": 4.0, "sprite": Color.DARK_RED, "pattern": Pattern.pattern1},
	{"distance": 5.0, "sprite": Color.DARK_GREEN, "pattern": Pattern.pattern3},
]}
...
Night {night_count}[/center][/font_size]"""
	...
	{"distance": 5.0, "sprite": Color.GREEN_YELLOW, "pattern": Pattern.pattern3},
	{"distance": 6.5, "sprite": Color.DARK_RED, "pattern": Pattern.pattern1},
	{"distance": 7.0, "sprite": Color.DARK_RED, "pattern": Pattern.pattern1},
	{"distance": 7.5, "sprite": Color.GREEN_YELLOW, "pattern": Pattern.pattern3},
]}
