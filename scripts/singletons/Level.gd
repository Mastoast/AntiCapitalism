...
var level2 = {
	...
	"combo_bar_start": 50.0, "combo_decrease_speed" : 1.2,
...
var level3 = {
	...
	"combo_bar_start": 80.0, "combo_decrease_speed" : 1.5,
...
Night {night_count}[/center][/font_size]"""
	...
	{"distance": 3.0, "sprite": Color.MIDNIGHT_BLUE, "pattern": Pattern.pattern1},
	{"distance": 4.0, "sprite": Color.GREEN_YELLOW, "pattern": Pattern.pattern3},
	{"distance": 5.5, "sprite": Color.GREEN_YELLOW, "pattern": Pattern.pattern3},
